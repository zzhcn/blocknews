  ...
  <div id="apps">
    ...
    <section>
      ...
      <div class="content_box">
        ...
        <div class="submit_btn" @click="toReg()">确认</div>
        <!--<a class="to_find" href="find.html"><u>找回密码</u></a>-->
        <div class="to_login" @click="toLogin()"><u>已有账号，立即登录</u></div>
      </div>
    </section>
  </div>
</template>
    ...
    methods: {
      ...
      sendCode: function () {
        ...
        if (that.sendText == '发送验证码') {
          const that = this;
          const url = that.baseUrl + 'verificationCodes2';
          const data = {
            phone: that.regPhone
          };
          ax.post(url, data).then(function (res) {
